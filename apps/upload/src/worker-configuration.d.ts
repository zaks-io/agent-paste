/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/worker-configuration.d.ts --config wrangler.jsonc --env preview` (hash: 221254fd748c5698eefd189af87d97d5)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "API_KEY_ENV" | "API_BASE_URL" | "CONTENT_BASE_URL" | "UPLOAD_BASE_URL" | "UPLOAD_URL_TTL_SECONDS">> {}
}
