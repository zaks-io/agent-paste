/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/worker-configuration.d.ts --config wrangler.jsonc --env preview` (hash: 0d31328dffa11710c214a9f62e660138)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AGENT_PASTE_ENV" | "API_KEY_ENV" | "API_BASE_URL" | "CONTENT_BASE_URL" | "CONTENT_CAPABILITY_DOMAIN" | "CONTENT_CAPABILITY_HOST_SUFFIX" | "UPLOAD_BASE_URL" | "UPLOAD_URL_TTL_SECONDS" | "DOCS_BASE_URL" | "API_KEY_PEPPER_V1" | "ARTIFACT_BYTES_ENCRYPTION_KEY" | "CONTENT_SIGNING_SECRET" | "UPLOAD_SIGNING_SECRET">> {}
}
