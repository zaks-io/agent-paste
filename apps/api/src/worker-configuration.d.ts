/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/worker-configuration.d.ts --config wrangler.jsonc --env preview` (hash: 58ccc394c5adbf8b8dcfa1eb773e94ab)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "API_KEY_ENV" | "API_BASE_URL" | "CONTENT_BASE_URL" | "CLEANUP_BATCH_SIZE">> {}
}
