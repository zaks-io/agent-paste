/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/worker-configuration.d.ts --config wrangler.jsonc --env preview` (hash: a472af322e4ad289b79b7e7813bdf4aa)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "API_KEY_ENV" | "API_BASE_URL" | "CONTENT_BASE_URL" | "WEB_BASE_URL" | "CLEANUP_BATCH_SIZE" | "EPHEMERAL_PROVISION_DELAY_MS" | "AGENT_PASTE_ENV" | "BILLING_ENABLED" | "DOCS_BASE_URL" | "WORKOS_CLIENT_ID" | "WORKOS_ISSUER" | "WORKOS_CLI_AUDIENCE" | "WORKOS_CLI_JWKS_URL" | "WORKOS_CLI_ISSUER" | "WORKOS_MCP_AUDIENCE" | "WORKOS_MCP_JWKS_URL" | "WORKOS_MCP_ISSUER" | "CF_ACCESS_TEAM_DOMAIN" | "ACCESS_LINK_SIGNING_KEY_V1" | "API_KEY_PEPPER_V1" | "ARTIFACT_BYTES_ENCRYPTION_KEY" | "CONTENT_SIGNING_SECRET" | "STREAM_INTERNAL_SECRET" | "WORKOS_API_KEY">> {}
}
