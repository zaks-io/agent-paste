/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/worker-configuration.d.ts --config wrangler.jsonc --env preview` (hash: b07bed4a4f9cd24b175d47d862290124)
...
interface __BaseEnv_Env {
	...
	WRITE_ALLOWANCE: DurableObjectNamespace /* WorkspaceWriteAllowance */;
	EPHEMERAL_PROVISION_GATE: DurableObjectNamespace /* EphemeralProvisionGate */;
}
