/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/worker-configuration.d.ts --config wrangler.jsonc --env preview` (hash: b1f3107815111086634159d776aac63a)
// Runtime types generated with workerd@1.20260521.1 2026-05-21 nodejs_compat
interface __BaseEnv_Env {
	...
	BUNDLE_GENERATE_QUEUE: Queue;
	SAFETY_SCAN_QUEUE: Queue;
	ACTOR_RATE_LIMIT: RateLimit;
	WORKSPACE_BURST_CAP: RateLimit;
	ARTIFACT_RATE_LIMIT: RateLimit;
	EPHEMERAL_PROVISION_IP_RATE_LIMIT: RateLimit;
	EPHEMERAL_PROVISION_GLOBAL_RATE_LIMIT: RateLimit;
	API_KEY_ENV: "preview";
	API_BASE_URL: "https://agent-paste-api-preview.isaac-a46.workers.dev";
	CONTENT_BASE_URL: "https://usercontent.preview.agent-paste.link";
	...
	CONTENT_CAPABILITY_HOST_SUFFIX: "-preview";
	...
	WRITE_ALLOWANCE: DurableObjectNamespace<import("./index").WorkspaceWriteAllowance>;
	EPHEMERAL_PROVISION_GATE: DurableObjectNamespace<import("./index").EphemeralProvisionGate>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./index");
		durableNamespaces: "WorkspaceWriteAllowance" | "EphemeralProvisionGate";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "API_KEY_ENV" | "API_BASE_URL" | "CONTENT_BASE_URL" | "WEB_BASE_URL" | "CLEANUP_BATCH_SIZE" | "EPHEMERAL_PROVISION_DELAY_MS" | "AGENT_PASTE_ENV" | "CONTENT_CAPABILITY_DOMAIN" | "CONTENT_CAPABILITY_HOST_SUFFIX" | "BILLING_ENABLED" | "DOCS_BASE_URL" | "WORKOS_CLIENT_ID" | "WORKOS_ISSUER" | "WORKOS_CLI_AUDIENCE" | "WORKOS_CLI_JWKS_URL" | "WORKOS_CLI_ISSUER" | "WORKOS_MCP_AUDIENCE" | "WORKOS_MCP_JWKS_URL" | "WORKOS_MCP_ISSUER" | "CF_ACCESS_TEAM_DOMAIN" | "API_KEY_PEPPER_V1" | "ARTIFACT_BYTES_ENCRYPTION_KEY" | "CONTENT_SIGNING_SECRET" | "WORKOS_API_KEY">> {}
}
