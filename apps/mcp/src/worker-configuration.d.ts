/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/worker-configuration.d.ts --config wrangler.jsonc --env preview` (hash: b838ec4d7e652b140186c879c0420938)
// Runtime types generated with workerd@1.20260520.1 2026-05-21 nodejs_compat
interface __BaseEnv_Env {
	MCP_IP_RATE_LIMIT: RateLimit;
	...
	API: Service /* entrypoint McpApiEntrypoint from agent-paste-api-preview */;
	UPLOAD: Service /* entrypoint McpUploadEntrypoint from agent-paste-upload-preview */;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AGENT_PASTE_ENV" | "SENTRY_TRACES_SAMPLE_RATE" | "MCP_RESOURCE" | "MCP_AUTHORIZATION_SERVER" | "WORKOS_MCP_AUDIENCE" | "WORKOS_MCP_JWKS_URL" | "WORKOS_MCP_ISSUER" | "WORKOS_API_KEY">> {}
}
