  ...
  return (
    <button
      ...
      className="
        ...
        bg-surface-sunken text-sm text-muted
        hover:text-foreground hover:border-rule-strong
    ...
    >
      ...
      <kbd className="hidden md:inline text-mono-sm text-subtle font-medium">{shortcutLabel}</kbd>
    </button>
  );
}
