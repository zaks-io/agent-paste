      ...
      <PageHeader
        ...
        description={
          <>
            ...
            <code className="font-mono text-xs">npx @zaks-io/agent-paste login</code>; secrets are shown once on
            creation.
          </>
        }
      />
          ...
          <EmptyState
            ...
            body={
              <>
                ...
                <code className="font-mono text-xs">npx @zaks-io/agent-paste login</code>. Create one here for CI or
                headless use.
              </>
            }
          />
