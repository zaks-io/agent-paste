...
export const ABOUT_SECTIONS: AboutSection[] = [
  {
    ...
    body: [
      ...
      "agent-paste fills exactly that gap and nothing wider. Point the agent at agent-paste.sh and it turns a folder into an `Artifact` with its own stable capability URL for the human and an Agent View manifest for the agent that consumes it.",
    ],
  },
  {
    title: "Why it exists",
