      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            ...
            "Artifact URLs use random capability hostnames with at least 95 bits of entropy, backed by signed authorization. Full bearer URLs are designed to stay out of normal server-side logs.",
