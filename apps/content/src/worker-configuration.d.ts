/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/worker-configuration.d.ts --config wrangler.jsonc --env preview` (hash: e22b675236e46ddedaf1c066961677ab)
...
interface __BaseEnv_Env {
	...
	CAPABILITY_LOOKUP_RATE_LIMIT: RateLimit;
	AGENT_PASTE_ENV: "preview";
	CONTENT_BASE_URL: "https://usercontent.preview.agent-paste.link";
	CONTENT_LEGACY_BASE_URL: "https://usercontent.preview.agent-paste.sh";
	CONTENT_CAPABILITY_DOMAIN: "agent-paste.link";
	CONTENT_LEGACY_CAPABILITY_DOMAIN: "agent-paste.sh";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AGENT_PASTE_ENV" | "CONTENT_BASE_URL" | "CONTENT_LEGACY_BASE_URL" | "CONTENT_CAPABILITY_DOMAIN" | "CONTENT_LEGACY_CAPABILITY_DOMAIN" | "CONTENT_CAPABILITY_HOST_SUFFIX" | "CONTENT_SIGNING_KID" | "DOCS_BASE_URL" | "ARTIFACT_BYTES_ENCRYPTION_KEY" | "CONTENT_SIGNING_SECRET">> {}
}
