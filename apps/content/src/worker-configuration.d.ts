/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/worker-configuration.d.ts --config wrangler.jsonc --env preview` (hash: ce4b5efeb51c856fe996a33f8c20d640)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AGENT_PASTE_ENV" | "CONTENT_CAPABILITY_DOMAIN" | "CONTENT_CAPABILITY_HOST_SUFFIX" | "CONTENT_SIGNING_KID" | "DOCS_BASE_URL" | "ARTIFACT_BYTES_ENCRYPTION_KEY" | "CONTENT_SIGNING_SECRET">> {}
}
