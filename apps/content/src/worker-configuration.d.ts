/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/worker-configuration.d.ts --config wrangler.jsonc --env preview` (hash: 092518b82d901b59e169cdc86bbb7e29)
...
interface __BaseEnv_Env {
	...
	CONTENT_BASE_URL: "https://usercontent.preview.agent-paste.sh";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AGENT_PASTE_ENV" | "CONTENT_BASE_URL" | "CONTENT_CAPABILITY_DOMAIN" | "CONTENT_CAPABILITY_HOST_SUFFIX" | "CONTENT_SIGNING_KID" | "DOCS_BASE_URL" | "ARTIFACT_BYTES_ENCRYPTION_KEY" | "CONTENT_SIGNING_SECRET">> {}
}
