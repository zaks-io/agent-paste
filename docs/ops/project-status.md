...
Last updated: 2026-05-23 (web auth swapped from Auth0 to WorkOS AuthKit per ADR 0068, workspace member DB foundation completed, ADR 0002 superseded for `apps/web`; status + ADR coverage reconciled; Logpush and production deploy-gate work parked for later).
