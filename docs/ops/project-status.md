...
| `docs/specs/mvp.md`               | Partial | Publish/read flows work; delete/expiry byte-purge is verified in local/hosted smoke. Remaining MVP-shaped hardening is the interim operator/rotation follow-ups.                                                                                               |
