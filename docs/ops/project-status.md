...
Last updated: 2026-05-23 (WorkOS web callback API implemented; ADR 0045 rotation groundwork runbook added; web auth swapped from Auth0 to WorkOS AuthKit per ADR 0068; workspace member DB foundation completed; Logpush and production deploy-gate work parked for later).
...
| --------------------- | ---------------------- | ---------- | ----- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `apps/api`            | Implemented            | ~950       | Yes   | `src/index.ts`. Hono routing, `/openapi.json`, public Agent View, admin routes, scheduled cleanup, signed content URLs, denylist writes, WorkOS web callback member provisioning.                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
...
| 0055 signup auto-provisions workspace     | Partial      | `POST /v1/auth/web/callback` now provisions a Personal Workspace, Workspace Member, and default API Key on first WorkOS AuthKit login. Remaining Phase 3 work is real WorkOS project/secret setup and the rest of the dashboard API surface.                                                                                                                                          |
