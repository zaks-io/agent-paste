...
- Jobs call-shape or harness tests: `apps/jobs/src/jobs-coverage.test.ts`, `index.test.ts`, `smoke.test.ts`, `smoke-sync-byte-purge.test.ts`, `db.test.ts`, `lifecycle/bundle-generate-enqueue.test.ts`, `discovery/billing-reconcile.test.ts`, `bundle/generate-zip.test.ts`, `op-log-sentry.test.ts`, `queue.test.ts`.
...
- Merged coverage passed the project gate at 80.77% branch coverage.
