...
| ------------------ | -------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `packages/billing` | Partial        | Reconciliation backstop, `BillingProvider` seam, plan projection via `runCommand`, and drift logging; Checkout/webhooks/Portal remain for AP-5.                                                                        |
