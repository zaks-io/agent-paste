...
| Jobs queues        | Phase 4        | `apps/jobs` has Wrangler queue/DLQ bindings, consumers, and lifecycle byte purge/retention sweeps; bundle generation remains follow-up (phase-backlog #6).                                                             |
