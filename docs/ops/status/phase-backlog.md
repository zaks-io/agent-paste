...
6. [ ] Promote status after the above lands: mark `apps/web` implemented rather
       than scaffolded, mark ADR 0033/0059/0068 coverage appropriately, and
       update the Phase 3 summary in `project-status.md`.
