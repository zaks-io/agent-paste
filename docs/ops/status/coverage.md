...
| `docs/specs/style-guide.md`       | Partial  | Web applies tokens/components; cmd-k command palette and per-route titles remain.                                                                      |
...
| `docs/specs/web.md`               | Partial  | WorkOS AuthKit dashboard auth/read/mutation basics and operator lockdown UI are live; Access Link viewer is a placeholder; cmd-k/titles polish remain. |
...
| 0033 TanStack Start web               | Partial              | WorkOS AuthKit dashboard is live with operator lockdown UI and Lighthouse a11y gate; Access Link viewer is a placeholder; cmd-k and per-route titles remain. |
...
| 0059 web session/auth forwarding      | Partial              | Auth forwarding works; first-load race fixed; WorkOS runbook exists; deep-link return path deferred (phase-backlog item 7).                                  |
