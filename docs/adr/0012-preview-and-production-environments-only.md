...
- Preview uses development Auth0 credentials and preview-scoped database and R2 resources.
- Production uses production Auth0 credentials, production Postgres, and production R2 resources.
