...
| 16  | Daily new-Artifact write allowance — ephemeral      | 20 / day                                           | platform-controlled (operator-tunable) | write-allowance counter ([0075](./0075-agent-first-ephemeral-publish-and-write-gated-monetization.md)) | [0075](./0075-agent-first-ephemeral-publish-and-write-gated-monetization.md) |
| 17  | Daily new-Artifact write allowance — claimed `free` | 100 / day                                          | platform-controlled (operator-tunable) | write-allowance counter                                                                                | [0075](./0075-agent-first-ephemeral-publish-and-write-gated-monetization.md) |
| 18  | Daily new-Artifact write allowance — `pro`          | 2000 / day (fair-use)                              | platform-controlled (operator-tunable) | write-allowance counter                                                                                | [0075](./0075-agent-first-ephemeral-publish-and-write-gated-monetization.md) |
| 19  | Per-Artifact lifetime Revision ceiling              | 100 / **Artifact**                                 | platform-controlled (operator-tunable) | write-allowance counter                                                                                | [0075](./0075-agent-first-ephemeral-publish-and-write-gated-monetization.md) |
| 20  | Ephemeral Auto Deletion                             | 24 hours since **Publish**                         | platform-controlled                    | `jobs` auto-deletion sweep                                                                             | [0075](./0075-agent-first-ephemeral-publish-and-write-gated-monetization.md) |
