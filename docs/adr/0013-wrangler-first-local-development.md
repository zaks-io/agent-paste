...
- Use Wrangler/R2 development bindings for storage where practical.
- Authentication locally should use a real development WorkOS configuration or the repo's WorkOS-compatible local harness rather than a bespoke mock auth system.
