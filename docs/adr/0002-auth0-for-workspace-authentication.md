...
Status: Superseded. WorkOS is the current human-auth provider for `apps/web` ([ADR 0068](./0068-workos-authkit-for-web-app-auth.md)), CLI login ([ADR 0060](./0060-cli-authentication-via-auth0-loopback.md)), and MCP ([ADR 0061](./0061-mcp-worker-with-oauth-only-via-auth0-dcr.md)).
