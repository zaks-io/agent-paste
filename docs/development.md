...
| [`apps/mcp`](../apps/mcp)                                 | Implemented | OAuth-only hosted MCP Worker: Streamable HTTP transport, WorkOS bearer verification, and the publish/read/edit/links surface over service bindings to `api` and `upload`.       |
