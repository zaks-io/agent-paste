...
export const RepositoryErrorCode = {
  ...
  base_revision_artifact_mismatch: "base_revision_artifact_mismatch",
  base_revision_not_found: "base_revision_not_found",
  base_revision_not_publishable: "base_revision_not_publishable",
  ...
  deleted_path_not_in_base: "deleted_path_not_in_base",
  ...
  forbidden: "forbidden",
  inherited_path_not_blob_backed: "inherited_path_not_blob_backed",
...
const repositoryErrorToAppErrorMap: Record<RepositoryErrorCode, ErrorCodeValue | null> = {
  ...
  api_key_not_found: "api_key_not_found",
  artifact_not_found: "artifact_not_found",
  base_revision_artifact_mismatch: "invalid_request",
  base_revision_not_found: "invalid_request",
  base_revision_not_publishable: "invalid_request",
  create_postgres_services_missing_connection_or_executor: null,
  current_api_key_not_found: "not_authenticated",
  deleted_path_not_in_base: "invalid_request",
  draft_revision_conflict: "draft_revision_conflict",
  ...
  file_size_cap_exceeded: "file_size_cap_exceeded",
  forbidden: "forbidden",
  inherited_path_not_blob_backed: "invalid_request",
