...
- **Automation** — `buildRotationPlan`, versioned secret profiles, and overlap E2E helpers used by `scripts/rotate-versioned-secret.mjs` (see `docs/ops/runbook-rotation.md`).
