...
The artifact ID is the first part of its hostname. Full URLs also work. Updates require Workspace access.
...
binary files, and accountless publishing. Use the artifact ID in `artifact_id`; full URLs also work. Full docs: <https://agent-paste.sh/agents.md>.
