---
name: agent-paste-local-code-review
description: Use when reviewing local agent-paste changes, an implementation branch, or an uncommitted diff before opening a PR.
---

# Agent Paste Local Code Review
...
Also use `agent-paste-code-review` and its checklist for the bug taxonomy.
...
- The branch or PR metadata includes the `AP-<number>` issue.
