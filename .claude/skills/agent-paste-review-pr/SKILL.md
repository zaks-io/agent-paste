---
name: agent-paste-review-pr
description: Use when reviewing an agent-paste PR against its Linear issue, acceptance criteria, security invariants, tests, and docs.
---

# Agent Paste Review PR
