...
3. Delegate implementation.
   ...
   - Include the selected Linear issue identifier, issue URL, relevant doc
     ...
     `agent-paste-implement-issue`, and "do not create another worktree."
...
4. Coordinator review.
   ...
   - Run `agent-paste-local-code-review` or the repo-local
     `agent-paste-code-review` skill before PR creation.
...
5. Run exactly one local CodeRabbit pass, then open the PR.
   ...
   - Use `agent-paste-create-pr` for PR conventions if helpful, but override
...
docs/agents/issue-tracker.md, agent-paste-implement-issue, and the full issue
...
Run or request agent-paste-local-code-review before PR handoff. Final report:
