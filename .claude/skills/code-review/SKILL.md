---
name: code-review
description: Bug-focused pre-PR code review for local diffs, PRs, and remote Cursor review handoffs. Use when asked to review code, check a diff, run a pre-commit or pre-PR review, decide whether CodeRabbit is warranted, or prepare a remote Cursor Background Agent code-review prompt.
---
